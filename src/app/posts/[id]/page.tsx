...
const PostPage = ({ params }: PostPageProps) => {
  ...
  return (
    <div
      className = 'h-screen bg-[#08f1e6] relative w-full p-6 overflow-auto'
    >
      <div
      ...
      >
        <h3
          className={`text-left font-sans font-[900] text-[#3e3e3e] ${
        ...
        <p
          className={`text-left font-sans font-[400] text-[#3e3e3e] ${
            isMobile ? 'text-[2.6rem]' : 'text-[2rem]'
          }`}
        >
          {post.body}
        </p>
